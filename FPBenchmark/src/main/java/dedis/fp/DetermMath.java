...
//    public static void logPrimitiveStats(String fname, long[] mathMeas, long[] mpfrMeas) throws IOException {
//        String out = STATS_PREFIX + fname + ".csv";
//        Stats statMath = Stats.of(mathMeas);
//        Stats statMpfr = Stats.of(mpfrMeas);
//        FileWriter writer = new FileWriter(out);
//        writer.write(String.format("%s, %.1f (%f), %.1f (%f)\n",
//                fname,
//                statMath.mean(),
//                statMath.sampleStandardDeviation(),
//                statMpfr.mean(),
...
//    public static void logStats(String fname, long[] mathMeas, long[] smathMeas, long[] mpfrMeas) throws IOException {
//        String out = STATS_PREFIX + fname + ".csv";
//        Stats statMath = Stats.of(mathMeas);
//        Stats statSmath = Stats.of(smathMeas);
//        Stats statMpfr = Stats.of(mpfrMeas);
...
//            logStats(fname, mathTimes, smathTimes, mpfrTimes);
            logStats(fname, mathTimes, smathTimes, mpfrTimes, mfTimes);
        }

//        logMeasurements(outMath, mathTimes);
//        logMeasurements(outMpfr, mpfrTimes);
//        if (!isPrimitive) {
//            logMeasurements(outSmath, smathTimes);
//        }
    }

    public static void main(String[] args) {
        // RUN EXPERIMENT FOR COMPARING MATH LIBRARIES
...
//        Stats s = Stats.of(arr);
//        System.out.println(s.sampleStandardDeviation());
//        System.out.println(s.mean() + " " + Stats.meanOf(arr));
    }
}
